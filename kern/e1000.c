...
e1000_attach(struct pci_func *pcif)
{
  ...
  static_assert(sizeof(struct tx_desc) == 16 &&
                sizeof(struct rcv_desc) == 16);

  cprintf("pcif->reg_size: 0x%x\npcif->reg_base: 0x%08x\n",
          pcif->reg_size[0],
          pcif->reg_base[0]);
  ...
  assert(e1000[E1000_TDBAL] % 0x10 == 0 &&
         e1000[E1000_TDLEN] % 0x80 == 0);
  ...
  // Get 48-bit ethernet address
  /* e1000[E1000_EERD]  = 0;
  e1000[E1000_EERD] |= E1000_EERD_START;
  while ((e1000[E1000_EERD] & E1000_EERD_DONE) == 0)
    ;
  e1000[E1000_FILTER_RAL] = e1000[E1000_EERD] >> E1000_EERD_DATA_SHIFT;

  e1000[E1000_EERD]  = 1 << E1000_EERD_ADDR_SHIFT;
  e1000[E1000_EERD] |= E1000_EERD_START;
  while ((e1000[E1000_EERD] & E1000_EERD_DONE) == 0)
    ;
  e1000[E1000_FILTER_RAL] |= e1000[E1000_EERD] & 0xffff0000;

  e1000[E1000_EERD]  = 2 << E1000_EERD_ADDR_SHIFT;
  e1000[E1000_EERD] |= E1000_EERD_START;
  while ((e1000[E1000_EERD] & E1000_EERD_DONE) == 0)
    ;
  e1000[E1000_FILTER_RAH] = e1000[E1000_EERD] >> E1000_EERD_DATA_SHIFT;
*/
  ...
  cprintf("Ethernet Address: 0x%08x%08x\n", e1000[E1000_FILTER_RAH],
                                            e1000[E1000_FILTER_RAL]);

  // Zero MTA
  // void *mta = &e1000[E1000_MTA];
  // memset(mta, 0, E1000_MTA_LEN);
...
e1000_receive(uint8_t *data)
{
  ...
  if ((rcv_queue[rdt].status & E1000_RDESC_STATUS_EOP) == 0)
    panic("e1000_receive: cannot handle jumbo frames yet");
